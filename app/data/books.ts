...
export const readingBooks: ReadingBook[] = [
  ...
  { title: '白夜行', author: '东野圭吾', wikipediaUrl: wikipediaSearch('白夜行 东野圭吾'), coverUrl: amazonCover('81N085JDd4L') },
  { title: '嫌疑人X的献身', author: '东野圭吾', wikipediaUrl: wikipediaSearch('嫌疑人X的献身'), coverUrl: amazonCover('71SR0bUTAfL') },
  { title: '恶意', author: '东野圭吾', wikipediaUrl: wikipediaSearch('恶意 东野圭吾'), coverUrl: amazonCover('71vdvKwrCRL') },
  { title: '放学后', author: '东野圭吾', wikipediaUrl: wikipediaSearch('放学后 东野圭吾'), coverUrl: amazonCover('81LzuzdTz7L') },
  { title: '秘密', author: '东野圭吾', wikipediaUrl: wikipediaSearch('秘密 东野圭吾'), coverUrl: amazonCover('61B-sHtOkIL') },
  { title: '幻夜', author: '东野圭吾', wikipediaUrl: wikipediaSearch('幻夜 东野圭吾'), coverUrl: amazonCover('81LjwvE9vJL') },
  { title: '新参者', author: '东野圭吾', wikipediaUrl: wikipediaSearch('新参者 东野圭吾'), coverUrl: amazonCover('81F0-8qwEDL') },
  { title: '祈祷落幕时', author: '东野圭吾', wikipediaUrl: wikipediaSearch('祈祷落幕时'), coverUrl: amazonCover('71E20Mg7p3L') },
  { title: '沉睡的森林', author: '东野圭吾', wikipediaUrl: wikipediaSearch('沉睡的森林 东野圭吾'), coverUrl: amazonCover('71Mxo6xZ4VL') },
  { title: '麒麟之翼', author: '东野圭吾', wikipediaUrl: wikipediaSearch('麒麟之翼'), coverUrl: amazonCover('81mirP+CPdL') },
  { title: '东方快车谋杀案', author: '阿加莎·克里斯蒂', wikipediaUrl: wikipediaSearch('东方快车谋杀案'), coverUrl: amazonCover('71ihbKf67RL') },
  { title: '无人生还', author: '阿加莎·克里斯蒂', wikipediaUrl: wikipediaSearch('无人生还 阿加莎'), coverUrl: amazonCover('81QbgfCoVXL') },
  ...
  { title: '查拉图斯特拉如是说', author: '弗里德里希·尼采', wikipediaUrl: wikipediaSearch('查拉图斯特拉如是说'), coverUrl: amazonCover('61W5YrBWmrL') },
  { title: '存在与时间', author: '马丁·海德格尔', wikipediaUrl: wikipediaSearch('存在与时间'), coverUrl: amazonCover('6150bIphneL') },
  { title: '圣经', author: '基督教经典', wikipediaUrl: wikipediaSearch('圣经'), coverUrl: amazonCover('51ucI-SQlBL') }
]
